...
public class SmartListHelper
{
    ...
    public String getSearchResultsSummary()
    {
        ...
        else if (this.fullListSize == 1 && this.currentGroup == 1)
        {
            objs = new Object[]{this.properties.getPagingItemName()};
            message = this.properties.getPagingFoundOneItem();
        }
        else if (computedPageCount() == 1 && this.currentGroup == 1)
        {
            objs = new Object[]{
     ...
     * @return String
     */
    public String getPageNavigationBar(Href baseHref, Href baseHrefAction, String pageParameter, String groupParameter, String tableParameter, String tableName, HttpSession session)
    {
