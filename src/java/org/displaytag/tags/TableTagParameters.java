...
public final class TableTagParameters
{
    ...
    /**
     * name of the parameter specifying the current group.
     */
    public static final String PARAMETER_GROUP = "g"; //$NON-NLS-1$
    
    
    /**
     * name of the parameter specifying the current table
     */
    public static final String PARAMETER_TABLE = "t"; //$NON-NLS-1$
