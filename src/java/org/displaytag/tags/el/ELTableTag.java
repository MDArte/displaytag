...
public class ELTableTag extends org.displaytag.tags.TableTag
{
    ...
    /**
     * Expression for the "requestURIAction" tag attribute.
     */
    private String requestURIActionExpr;   
    ...
    private void evaluateExpressions() throws JspException
    {
        ...
        if (requestURIActionExpr != null)
        {
            super.setRequestURIAction(eval.evalString("requestURIAction", requestURIActionExpr)); //$NON-NLS-1$
        }   
        if(tableNameExpr != null){
        	super.setTableName(eval.evalString("tableName", tableNameExpr));
        }
    ...
    public void release()
    {
        ...
        this.requestURIActionExpr = null;
