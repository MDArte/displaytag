...
public class ELTableTagBeanInfo extends SimpleBeanInfo
{
    ...
    public PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try
        {
            ...
            proplist.add(new PropertyDescriptor("requestURIAction", //$NON-NLS-1$
                    ELTableTag.class, null, "setRequestURIAction")); //$NON-NLS-1$         
            proplist.add(new PropertyDescriptor("tableName", //$NON-NLS-1$
                    ELTableTag.class, null, "setTableName")); //$NON-NLS-1$              
