...
public class Row
{
    ...
    public String getOpenTag()
    {
        ...
        try {
			Method method = this.rowObject.getClass().getMethod("getAlerta", null);
			try {
				Object obj = method.invoke(this.rowObject, null);
				if(obj == null || obj.equals(""))
					css = this.tableModel.getProperties().getCssRow(1);
				else
					css = (String)obj;
			} catch (Exception e) {
			}
