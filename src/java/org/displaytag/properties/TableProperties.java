...
public final class TableProperties implements Cloneable
{
    ...
    /**
     * property <code>paging.banner.first.last</code>.
     */
    public static final String PROPERTY_STRING_PAGING_BANNER_FIRST_LAST = "paging.banner.first.last"; //$NON-NLS-1$
    /**
    ...
    {
    	// default size is 10
        return getIntProperty(PROPERTY_INT_PAGING_GROUPSIZE, 10);
    }
    ...
    /**
     * Getter for the <code>PROPERTY_STRING_PAGING_BANNER_FIRST_LAST</code> property.
     * @return String
     */
    public String getPagingBannerFirstLast()
    {
        return getProperty(PROPERTY_STRING_PAGING_BANNER_FIRST_LAST);
    }
    /**
